...
public class VentanaPrincipal {
	...
	public void inicializarComponentes(){
		...
		settings.gridy = 0;
		settings.ipadx = 80;
		settings.insets = new Insets(0, 0, 0, 30); //Le he dado un poco de inset por la derecha para cuadrar la pantalla.
		settings.fill = GridBagConstraints.BOTH;
		ventana.add(panelDer,settings);
		
		
		panelRBotones = new JPanel();
		panelRBotones.setBorder(BorderFactory.createTitledBorder(
		...
		//El iconito de nuevo:
		nuevoB.setIcon(cargarIcono("Imagenes/new.png"));
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(returnVal == JFileChooser.APPROVE_OPTION) {  //SI HEMOS SELECIONADO UN FICHERO:
					...
					ImageIcon imagenIcon = new ImageIcon(
							imagenBuffer.getScaledInstance(imagenGrande.getWidth(),
	...
	//Método que me devuelve un image icon de tamaño 25x25 para una ruta de un fichero dado.
